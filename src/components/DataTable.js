...
const headRows = [
  ...
  { id: 'kontak', numeric: false, disablePadding: false, label: 'kontak' },
  { id: 'posisi', numeric: false, disablePadding: false, label: 'posisi' },
  { id: 'provinsi', numeric: false, disablePadding: false, label: 'provinsi' },
  { id: 'kecamatan', numeric: false, disablePadding: false, label: 'kecamatan' },
  { id: 'kota', numeric: false, disablePadding: false, label: 'kota' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.provinsi}</TableCell>
